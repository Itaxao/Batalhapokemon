...
public abstract class Pokemon {
    ...
    public Pokemon(String apelido, String especie, Tipo tipo, int nivelEvolucao, double vidaMaxima, double ataque, double ataqueEspecial, double defesa, double defesaEspecial, double velocidade) {
